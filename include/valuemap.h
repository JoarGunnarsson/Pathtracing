...
ValueMap1D const* create_value_map_1D(const std::string& file_name, double u_max = 1, double v_max = 1);
ValueMap3D const* create_value_map_3D(const std::string& file_name, double u_max = 1, double v_max = 1);
#endif
