...
class Object {
  public:
    ...
    virtual bool allow_direct_light(const vec3& intersection_point, const int primitive_ID) const;
    ...
    double area_to_angle_PDF_factor(const vec3& surface_point, const vec3& intersection_point,
